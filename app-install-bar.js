...
(function(){
  ...
  style.textContent = '#madarek-app-bar{position:fixed;bottom:0;left:0;right:0;z-index:9990;padding:8px 12px;background:#0d1117;border-top:1px solid rgba(255,255,255,0.08);display:flex;align-items:center;justify-content:space-between;gap:10px;direction:rtl;font-family:Tajawal,sans-serif;animation:abIn .3s ease}@keyframes abIn{from{transform:translateY(100%)}to{transform:translateY(0)}}#madarek-app-bar .ab-txt{font-size:12px;font-weight:600;color:rgba(255,255,255,0.7);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#madarek-app-bar .ab-btn{padding:7px 20px;border-radius:8px;background:#10b981;color:#fff;font-size:12px;font-weight:800;text-decoration:none;white-space:nowrap;flex-shrink:0;transition:background .2s}#madarek-app-bar .ab-btn:active{background:#059669}#madarek-app-bar .ab-x{background:none;border:none;color:rgba(255,255,255,0.25);font-size:18px;cursor:pointer;padding:2px 4px;line-height:1;flex-shrink:0}';
