...
(function(){
  ...
  var defaultMessages = {
    ...
    loggedIdle: { emoji: '🔥', text: 'لا تكسر سلسلتك! تدرّب اليوم', btn: 'ابدأ التدريب', link: 'select-section.html', color: '#f59e0b' },
    idle: [
      { emoji: '💪', text: 'كل سؤال يقرّبك من درجتك — ابدأ الحين!', color: '#8b5cf6' },
      { emoji: '🎯', text: 'آلاف الأسئلة مع شرح تفصيلي بانتظارك', color: '#6366f1' },
      { emoji: '⚡', text: '10 دقائق يومياً تكفي للتفوق — جرّب!', color: '#10b981' },
      { emoji: '🏆', text: 'منافسيك يتدربون الحين! لا تخليهم يسبقونك', color: '#ef4444' }
    ]
  };
